...
open class OAuth2WebViewController: UIViewController, UIWebViewDelegate {
    ...
    // var webView: UIWebView = UIWebView()  //commented out when switched to WKWebView UIWebView deprecated
    ...
    override open func viewDidLoad() {
        ...
        // webView.delegate = self  //commented out when switched to WKWebView UIWebView deprecated
