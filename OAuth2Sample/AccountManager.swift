 ...
 */
open class CampfireConfig: Config {
    /**
     Init a Campfire configuration.
    ...
    public init(clientId: String, clientSecret: String, scopes: [String], accountId: String? = nil, isOpenIDConnect: Bool = false) {
        super.init(base: "",
                   authzEndpoint: "https://campfire.com/api/oauth2/authorize",
                   redirectURL: "fb\(clientId)://authorize/",
            accessTokenEndpoint: "https://campfire.com/api/oauth2/token",
            clientId: clientId,
            refreshTokenEndpoint: "https://campfire.com/oauth/access_token",
            revokeTokenEndpoint: "https://campfire.com/me/permissions",
            isOpenIDConnect: isOpenIDConnect,
            userInfoEndpoint: isOpenIDConnect ? "https://campfire.com/v2.10/me" : nil,
            scopes: scopes,
...
open class AccountManager {
    ...
    */
    ...
    /**
     Convenient method to retrieve a Campfire OAuth2 module.
     
     :param: config a Campfire configuration object. See CampfireConfig.
     
     :returns: a Campfire OAuth2 module.
     */
    open class func addCampfireAccount(config: CampfireConfig) -> CampfireOAuth2Module {
        return addAccountWith(config: config, moduleClass: CampfireOAuth2Module.self) as! CampfireOAuth2Module
    }
